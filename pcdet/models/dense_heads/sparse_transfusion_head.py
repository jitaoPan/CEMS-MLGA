...
class SparseTransFusionHead(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # todo::  here pjt change
        local_max[:, 3] = F.max_pool2d(heatmap[:, 3], kernel_size=1, stride=1, padding=0) # Pedestrian
        local_max[:, 2] = F.max_pool2d(heatmap[:, 2], kernel_size=1, stride=1, padding=0) # Traffic Cone
