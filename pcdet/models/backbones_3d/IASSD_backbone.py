...
class IASSD_Backbone(nn.Module):
    ...
    def __init__(self, model_cfg, num_class, input_channels, **kwargs):
        ...
        for k in range(sa_config.NSAMPLE_LIST.__len__()):
            ...
            #     attention_dim = sa_config.MLPS[k][0]
            #     self.SA_modules.append(pointnet2_modules.SelfAttention(in_dim=in_dim, attention_dim=attention_dim))
    ...
    def forward(self, batch_dict):
        ...
        for i in range(len(self.SA_modules)):
            ...
            # elif self.layer_types[i] == 'Attn_Layer':  # i=6
            #     li_xyz, li_features = self.SA_modules[i](xyz_input, feature_input)
            #     li_cls_pred = None
            #
            # else:
            #     raise NotImplementedError
